...
sequenceDiagram
    ...
    activate browser
    Note left of browser: parse the html and request the css and javascript files
    browser->>server: GET https://studies.cs.helsinki.fi/exampleapp/main.js
    activate server
    server-->>browser: sends the main.js file
    activate browser
    Note left of browser: parse the main.js file and execute the javascript code
